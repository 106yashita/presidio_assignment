...
INSERT INTO DEPARTMENTT (deptname, FloorNumber, phone, empno) VALUES
('Management', 5, '34', 1),
('Books', 1, '81', 4),
('Clothes', 2, '24', 4),
('Equipment', 3, '57', 3),
...
INSERT INTO ITEMM (itemname, itemtype, itemcolor) VALUES
...
INSERT INTO SALESS(salesno, saleqty, itemname, deptname) VALUES
...
alter table EMPP
ADD CONSTRAINT fkdeptname FOREIGN KEY (deptname) REFERENCES DEPARTMENTT(deptname)

alter table EMPP
ADD CONSTRAINT fkbossno FOREIGN KEY (bossno) REFERENCES EMPP(empno)

alter table SALESS
ADD CONSTRAINT FKitemname FOREIGN KEY (itemname) REFERENCES ITEMM(itemname)

alter table SALESS
ADD CONSTRAINT fkdeptnamesales FOREIGN KEY (deptname) REFERENCES DEPARTMENTT(deptname)

alter table DEPARTMENTT
ADD CONSTRAINT fkempnokey FOREIGN KEY (empno) REFERENCES EMPP(empno) 